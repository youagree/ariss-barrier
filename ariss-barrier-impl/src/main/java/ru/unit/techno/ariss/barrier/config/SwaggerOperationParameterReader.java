...
package ru.unit.techno.ariss.barrier.config;
...
@Order
public class SwaggerOperationParameterReader implements OperationBuilderPlugin {
    ...
    @Autowired
    public SwaggerOperationParameterReader(TypeNameExtractor nameExtractor, TypeResolver resolver) {
